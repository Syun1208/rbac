...
@router.post('/login/swagger', summary='Swagger debugging only', description='Used to quickly obtain token for swagger authentication')
...
@router.post(
    '/login',
    summary='User login',
    description='Login in json format, only supports debugging in third-party API tools, such as postman',
...
@router.post('/token/new', summary='Create a new token')
