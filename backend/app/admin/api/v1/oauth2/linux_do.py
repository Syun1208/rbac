...
@router.get('', summary='Get the Linux Do License Link')
...
@router.get(
    '/callback',
    summary='Linux Do Authorization Automatic Redirection',
    description='Linux Do After authorization, automatically redirect to the current address and obtain user information, and automatically create a system user based on the user information',
